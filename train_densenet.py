...
run_dir = os.path.join(checkpoints_base_dir, f"densenet_{timestamp}")
...
model.classifier = nn.Sequential(nn.Dropout(0.5), nn.Linear(in_features, 7))
...
for epoch in range(num_epochs):
    ...
    artifact = wandb.Artifact(name=f"densenet_{timestamp}", type="model")
